...
namespace ExpenseItDemo
{
    ...
    public partial class MainWindow : Window
    {
        static MainWindow()
        {
            ...
            //Define ViewPhotosCommand
            ViewReceiptsCommand = new RoutedUICommand("_View Receipts", "ViewReceipts", typeof(MainWindow));
        }
        ...
        public MainWindow()
        {
            ...
            var commandBindingViewReceiptsCommand = new CommandBinding(ViewReceiptsCommand);
            commandBindingViewReceiptsCommand.Executed += commandBindingViewPhotosCommand_Executed;
            CommandBindings.Add(commandBindingViewReceiptsCommand);
        }
        ...
        private void commandBindingViewPhotosCommand_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ReceiptsList list = new ReceiptsList();
            list.Show();
        }
        ...
        public static RoutedUICommand ViewReceiptsCommand;
